        ...
        <div className="flex items-center">
          ...
          <nav className="ml-8 hidden md:flex">
            <ul className="flex space-x-6">
              <li><Link href="/jobs" className={`text-sm font-medium hover:text-red-600 ${isActive("/jobs") ? "text-red-600" : "text-gray-700"}`}>求人検索</Link></li>
              <li><Link href="/grandprix" className={`text-sm font-medium hover:text-red-600 ${isActive("/grandprix") ? "text-red-600" : "text-gray-700"}`}>就活グランプリ</Link></li>
              <li><Link href="/features" className={`text-sm font-medium hover:text-red-600 ${isActive("/features") ? "text-red-600" : "text-gray-700"}`}>特集</Link></li>
              {user && (
                <li>
                  <Link href={getDashboardLink()} className={`text-sm font-medium hover:text-red-600 ${isActive(getDashboardLink()) ? "text-red-600" : "text-gray-700"}`}>
            ...
            <>
              ...
              <div className="hidden md:flex items-center">
                <span className="mr-2 text-sm font-medium">
                  {userRole === "company" ? profile?.company_name : user.user_metadata?.full_name}
                </span>
